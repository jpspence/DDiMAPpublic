...
/home/jan/cushaw3-v3.0.2/cushaw3 index $myFasta -p ${mySpecimenID}_bwtindex
/home/jan/cushaw3-v3.0.2/cushaw3 align -r ${mySpecimenID}_bwtindex -q $myFastq -t 8 -multi 1 -avg_ins 344 -ins_std 69 -o ${myAligned}.sam
#
