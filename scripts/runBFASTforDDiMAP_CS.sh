...
bfast fasta2brg -f $myFasta -A 1

bfast index -f $myFasta -m 1111111111111111111111 -w 14 -i 1 -A 1 -n 8
bfast index -f $myFasta -m 111110100111110011111111111 -w 14 -i 2 -A 1 -n 8
bfast index -f $myFasta -m 10111111011001100011111000111111 -w 14 -i 3 -A 1 -n 8
bfast index -f $myFasta -m 1111111100101111000001100011111011 -w 14 -i 4 -A 1 -n 8
bfast index -f $myFasta -m 111111110001111110011111111 -w 14 -i 5 -A 1 -n 8
bfast index -f $myFasta -m 11111011010011000011000110011111111 -w 14 -i 6 -A 1 -n 8
bfast index -f $myFasta -m 1111111111110011101111111 -w 14 -i 7 -A 1 -n 8
bfast index -f $myFasta -m 111011000011111111001111011111 -w 14 -i 8 -A 1 -n 8
bfast index -f $myFasta -m 1110110001011010011100101111101111 -w 14 -i 9 -A 1 -n 8
bfast index -f $myFasta -m 111111001000110001011100110001100011111 -w 14 -i 10 -A 1 -n 8

export myBmf=$myPatient.bmf

bfast match -f $myFasta -A 1 -i 1-10 -k 18 -K 100000 -w 0 -t -n 8 -Q 100000 -l -r $myFastq > $myBmf

export myBaf=$myPatient.baf

bfast localalign -f $myFasta -m $myBmf -A 1 -n 8 -U -q 20 -Q 100000 -t > $myBaf
